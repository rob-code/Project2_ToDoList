...
public class SeedTasks {
    ...
    public SeedTasks() {
        ...
        Task task3 = new Task("Tea", "Sri Lanka", "Shopping", true);
        Task task4 = new Task("Bread", "Gluten free", "Shopping", false);
        Task task5 = new Task("Beans", "Baked", "Shopping", true);
        Task task6 = new Task("Crisps", "Stop buying these things!!", "Shopping", true);
        ...
        Task task9 = new Task("Movies with J", "Go and see something she will like", "Fun", true);
        ...
        Task task12 = new Task("Change bike tyres", "J's bike!", "Bikes", true);
